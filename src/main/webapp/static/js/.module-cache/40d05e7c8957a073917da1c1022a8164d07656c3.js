...
$w.LoginRows = React.createClass({displayName: 'LoginRows',
    ...
    render: function() {
        ...
        return (
          ...
          React.createElement("td", {id: "loginrow#xbool#"+i, style: {width:this.props.cw.c7,backgroundColor:bgcolor,textAlign:"right"}}, rcd.xbool), 
          React.createElement("td", {id: "loginrow#nbool#"+i, style: {width:this.props.cw.c8,backgroundColor:bgcolor,textAlign:"right"}}, rcd.nbool), 
          ...
          React.createElement("td", {id: "loginrow#xtime#"+i, style: {width:this.props.cw.c11,backgroundColor:bgcolor,textAlign:"right"}}, rcd.xtime), 
          React.createElement("td", {id: "loginrow#ntime#"+i, style: {width:this.props.cw.c12,backgroundColor:bgcolor,textAlign:"right"}}, rcd.ntime), 
          React.createElement("td", {id: "loginrow#date#"+i, style: {width:this.props.cw.c13,backgroundColor:bgcolor,textAlign:"right"}}, rcd.date), 
          React.createElement("td", {id: "loginrow#ndate#"+i, style: {width:this.props.cw.c14,backgroundColor:bgcolor,textAlign:"right"}}, rcd.ndate), 
          React.createElement("td", {id: "loginrow#xtimestamp#"+i, style: {width:this.props.cw.c15,backgroundColor:bgcolor,textAlign:"right"}}, rcd.xtimestamp), 
          React.createElement("td", {id: "loginrow#ntimestamp#"+i, style: {width:this.props.cw.c16,backgroundColor:bgcolor,textAlign:"right"}}, rcd.ntiemstamp), 
  ...
  render: function() {
    return (
      React.createElement("div", {className: "container-fixed", 
          style: {fontSize:12,border:1,borderStyle:"solid",width:920,height:600,backgroundColor: "#F0F0F0"}}, 
