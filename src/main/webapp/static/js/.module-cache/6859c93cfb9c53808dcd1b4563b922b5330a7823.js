...
$w.DetailRows = React.createClass({displayName: 'DetailRows',
 ...
 React.createElement("td", {id: "row##"+i, 
            style: {width:this.props.cw.c3,backgroundColor:bgcolor,textAlign:""}}, rcd.sec), 
 React.createElement("td", {id: "row#name#"+i, 
            style: {width:this.props.cw.c4,backgroundColor:bgcolor,textAlign:"left"}}, rcd.name), 
  ...
  render: function() {
    return (
      ...
      React.createElement(b.Row, {style: {verticalAlign:"middle", lineHeight:"26px",marginLeft:0}}, 
         React.createElement(b.Col, {xs: 1, style: {textAlign: "right"}}, "dummy"
          ), 
          React.createElement(b.Col, {xs: 2}, 
          React.createElement($c.SelectOption, {options: $c.stringOption, style: {height:24,  fontSize:12}, 
               name: "search#dummy", 
              defaultValue: this.state.search.dummy, onChange: this.handleChange})
          ), 
          React.createElement(b.Col, {xs: 3}, 
          React.createElement(b.Input, {type: "text", value: this.state.search.dummy_s, 
            name: "search#dummy_s", onChange: this.handleChange, 
            style: {height:24,fontSize:12,width:"100%"}})
          ), 
          React.createElement(b.Col, {xs: 3}, 
          React.createElement(b.Input, {type: "text", value: this.state.search.dummy_e, 
            name: "search#dymmy_e", onChange: this.handleChange, 
            style: {height:24,fontSize:12,width:"100%"}})
          ), 
      ...
      React.createElement(b.Table, {bordered: true, condensed: true, className: "wscrolltable"}, 
       React.createElement("thead", {style: {width:this.state.employee.totalW,overflowX:"hidden",overflowY:"hidden"}}, 
        React.createElement("tr", null, 
          ...
          React.createElement("th", {style: {width:this.state.employee.cw.c3}}, "sec"), 
          React.createElement("th", {style: {width:this.state.employee.cw.c4}}, "name"), 
          React.createElement("th", {style: {width:this.state.employee.cw.c5}}, "id"), 
          React.createElement("th", {style: {width:this.state.employee.cw.c6}}, "versionNo")
      ...
      React.createElement(b.Row, {style: {verticalAlign:"middle", lineHeight:"26px",marginLeft:0,marginRight:5}}, 
         React.createElement(b.Col, {xs: 1, style: {textAlign: "right"}}, "empCd"
          ...
          React.createElement(b.Input, {type: "text", value: this.state.form.empCd, 
            name: "form#empCd", onChange: this.handleChange, 
            style: {height:24,fontSize:12,width:"100%"}})
          )
      ), 
      React.createElement(b.Row, {style: {verticalAlign:"middle", lineHeight:"26px",marginLeft:0,marginRight:5}}, 
         React.createElement(b.Col, {xs: 1, style: {textAlign: "right"}}, "secId"
          ...
          React.createElement(b.Col, {xs: 3}, 
          React.createElement(b.Input, {type: "text", value: this.state.form.secId, 
            name: "form#secId", onChange: this.handleChange, 
            style: {height:24,fontSize:12,width:"100%"}})
          )
      ), 
      React.createElement(b.Row, {style: {verticalAlign:"middle", lineHeight:"26px",marginLeft:0,marginRight:5}}, 
