...
$w.LoginRows = React.createClass({displayName: 'LoginRows',
    ...
    render: function() {
        ...
        return (
          ...
          React.createElement("td", {id: "loginrow#xbool#"+i, style: {width:this.props.cw.c7,backgroundColor:bgcolor}}, rcd.xbool), 
          ...
          React.createElement("td", {id: "loginrow#ntimestamp#"+i, style: {width:this.props.cw.c16,backgroundColor:bgcolor}}, rcd.ntiemstamp), 
