  ...
  render: function() {
    return (
      React.createElement("div", {className: "container-fixed", 
          style: {fontSize:12,border:1,borderStyle:"solid",width:922,height:600,backgroundColor: "#F0F0F0"}}, 
      ...
      React.createElement("div", {style: {width:920,border:1,borderStyle:"solid",
