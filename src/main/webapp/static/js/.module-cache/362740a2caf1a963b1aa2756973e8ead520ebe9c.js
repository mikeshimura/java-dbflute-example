...
$w.LoginRows = React.createClass({displayName: 'LoginRows',
    ...
    render: function() {
        ...
        return (
          ...
          React.createElement("td", {id: "loginrow#id#"+i, style: {width:this.props.cw.c4,backgroundColor:bgcolor,textAlign:"right"}}, rcd.id), 
      ...
      onClick: $w.handleClick}, 
       React.createElement("thead", null, 
        React.createElement("tr", null, 
          React.createElement("th", {　style: {width:this.state.alltype.cw.c1}}, "Login Id"), 
          React.createElement("th", {style: {width:this.state.alltype.cw.c2}}, "氏名"), 
          React.createElement("th", {　style: {width:this.state.alltype.cw.c3}}, "id"), 
          React.createElement("th", {style: {width:this.state.alltype.cw.c4}}, "versionNo")
        )
      ), 
