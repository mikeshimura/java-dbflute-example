...
$w.Bool = React.createClass({displayName: 'Bool',
...
$w.LoginRows = React.createClass({displayName: 'LoginRows',
    ...
    render: function() {
        ...
        return (
          ...
          React.createElement("td", {id: "loginrow#xbool#"+i}, " ", React.createElement(b.Input, {type: "checkbox", value: rcd.xbool, 
                   style: {fontSize:12,width:this.props.cw.c7}})), 
          React.createElement("td", {id: "loginrow#nbool#"+i, style: {width:this.props.cw.c8,backgroundColor:bgcolor}}, React.createElement($w.Bool, {bool: rcd.nbool})), 
