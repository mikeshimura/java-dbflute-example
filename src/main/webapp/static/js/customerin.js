...
(function() {
  ...
  $w.handleClick = function(e) {
    var def, ids, name, ref, selRow, temp;
    name = e.target.name;
    ...
    if (ids[0] === "customer_row") {
      ...
      return $w.app.setState(temp, $w.setFocus.bind(this, ref, def));
    }
  };

  $w.handleRowKeyDown = function(e) {
    var curRow, def, done, jsx, name, names, ref, temp;
    jsx = $w.app;
    name = e.target.name;
    names = name.split("#");
    temp = {
      customer: jsx.state.customer
    };
    ...
    return jsx.setState(temp, $w.setFocus.bind(this, ref, def));
  };
  ...
  $w.customer_formUpdate = function() {
    var customertemp, def, dirty, i, j, len, oldrcds, oldrecord, params, rcd, rcds, ref, res, rules, tran;
    ...
    if (params.transactions.length > 0) {
      return $w.flux.actions.$c_rcd_transaction($w.app.state.customer, params, "customer");
    }
  };
  ...
  $w.customer_formDeleteCfm = function() {
    return $w.flux.actions.$c_rcd_delete($w.app.state.customer, $w.app.state.customer.rcds[$w.app.state.customer.selRow], "customer");
  };

  $w.customer_formCancel = function() {
    return $w.rcdSet();
  };
