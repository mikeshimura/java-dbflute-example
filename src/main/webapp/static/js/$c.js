...
(function() {
  ...
  $c.actions = {
    ...
    $c_deleteCfmShow: function(callback) {
      return this.dispatch($c.constants.$C_DELETE_CFM_SHOW, callback);
    },
  ...
  $c.CommonStore = Fluxxor.createStore({
    ...
    onDeleteCfmShow: function(callback) {
      this.data.deleteCfm.isShow = true;
      this.data.deleteCfm.callback = callback;
      this.emit("change");
    },
  ...
  $c.rcdActions = {
    $c_rcd_fetch: function(rcdData, form, table, criteria, maxRecord) {
      var context, params;
      params = {
        operationType: "fetch",
        data: {
