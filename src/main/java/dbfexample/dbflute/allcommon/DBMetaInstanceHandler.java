...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("customer", "dbfexample.dbflute.bsentity.dbmeta.CustomerDbm");
        tmpMap.put("employee", "dbfexample.dbflute.bsentity.dbmeta.EmployeeDbm");
        tmpMap.put("login", "dbfexample.dbflute.bsentity.dbmeta.LoginDbm");
        tmpMap.put("product", "dbfexample.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("sales_slip", "dbfexample.dbflute.bsentity.dbmeta.SalesSlipDbm");
