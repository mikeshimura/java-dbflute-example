...
public abstract class BsUserTable extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected List<Employee> _employeeList;

    /**
     * [get] employee by sec_id, named 'employeeList'.
     * @return The entity list of referrer property 'employeeList'. (NotNull: even if no loading, returns empty list)
     */
    public List<Employee> getEmployeeList() {
        if (_employeeList == null) { _employeeList = newReferrerList(); }
        return _employeeList;
    }

    /**
     * [set] employee by sec_id, named 'employeeList'.
     * @param employeeList The entity list of referrer property 'employeeList'. (NullAllowed)
     */
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_employeeList != null) { for (Employee et : _employeeList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "employeeList")); } } }
        return sb.toString();
    }
    ...
    protected String doBuildRelationString(String dm) {
        ...
        { sb.append(dm).append("employeeList"); }
        if (sb.length() > dm.length()) {
