...
public class BsCustomerCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public CustomerCB acceptPK(Integer id) {
     ...
     * @return this. (NotNull)
     */
    public CustomerCB acceptUniqueOf(String cusCd, Integer delFlag) {
        assertObjectNotNull("cusCd", cusCd);assertObjectNotNull("delFlag", delFlag);
        BsCustomerCB cb = this;
        cb.query().setCusCd_Equal(cusCd);cb.query().setDelFlag_Equal(delFlag);
        return (CustomerCB)this;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<CustomerCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCusCd() { return doColumn("cus_cd"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnAddr() { return doColumn("addr"); }
        /**
         * bldg: {varchar(100)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnBldg() { return doColumn("bldg"); }
        /**
         * cus_con_sec: {varchar(100)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCusConSec() { return doColumn("cus_con_sec"); }
        /**
         * cus_con_name: {varchar(100)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCusConName() { return doColumn("cus_con_name"); }
        /**
         * tel: {varchar(100)}
         * @return The information object of specified column. (NotNull)
         */
