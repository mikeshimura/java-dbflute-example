...
public class CustomerCIQ extends AbstractBsCustomerCQ {
    ...
    protected ConditionValue xgetCValueCusCd() { return _myCQ.xdfgetCusCd(); }
    protected ConditionValue xgetCValueName() { return _myCQ.xdfgetName(); }
    protected ConditionValue xgetCValueAddr() { return _myCQ.xdfgetAddr(); }
    protected ConditionValue xgetCValueBldg() { return _myCQ.xdfgetBldg(); }
    protected ConditionValue xgetCValueCusConSec() { return _myCQ.xdfgetCusConSec(); }
    protected ConditionValue xgetCValueCusConName() { return _myCQ.xdfgetCusConName(); }
