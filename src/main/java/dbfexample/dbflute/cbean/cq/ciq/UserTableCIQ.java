...
public class UserTableCIQ extends AbstractBsUserTableCQ {
    ...
    public String keepId_ExistsReferrer_EmployeeList(EmployeeCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepId_NotExistsReferrer_EmployeeList(EmployeeCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepId_SpecifyDerivedReferrer_EmployeeList(EmployeeCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepId_QueryDerivedReferrer_EmployeeList(EmployeeCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepId_QueryDerivedReferrer_EmployeeListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
