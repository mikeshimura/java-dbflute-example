...
public abstract class AbstractBsSessionCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<SessionCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, SessionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SessionCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, SessionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SessionCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, SessionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SessionCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, SessionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SessionCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, SessionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SessionCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, SessionCB.class);
    }
