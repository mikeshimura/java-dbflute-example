...
public abstract class AbstractBsCustomerCQ extends AbstractConditionQuery {
     ...
     * @param cusCd The value of cusCd as equal. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusCd_Equal(String cusCd) {
        doSetCusCd_Equal(fRES(cusCd));
    }

    protected void doSetCusCd_Equal(String cusCd) {
        regCusCd(CK_EQ, cusCd);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_cd: {UQ+, NotNull, varchar(40)}
     * @param cusCd The value of cusCd as notEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusCd_NotEqual(String cusCd) {
        doSetCusCd_NotEqual(fRES(cusCd));
    }

    protected void doSetCusCd_NotEqual(String cusCd) {
        regCusCd(CK_NES, cusCd);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_cd: {UQ+, NotNull, varchar(40)}
     * @param cusCd The value of cusCd as greaterThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusCd_GreaterThan(String cusCd) {
        regCusCd(CK_GT, fRES(cusCd));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_cd: {UQ+, NotNull, varchar(40)}
     * @param cusCd The value of cusCd as lessThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusCd_LessThan(String cusCd) {
        regCusCd(CK_LT, fRES(cusCd));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_cd: {UQ+, NotNull, varchar(40)}
     * @param cusCd The value of cusCd as greaterEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusCd_GreaterEqual(String cusCd) {
        regCusCd(CK_GE, fRES(cusCd));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_cd: {UQ+, NotNull, varchar(40)}
     * @param cusCd The value of cusCd as lessEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusCd_LessEqual(String cusCd) {
        regCusCd(CK_LE, fRES(cusCd));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * cus_cd: {UQ+, NotNull, varchar(40)}
     * @param cusCdList The collection of cusCd as inScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusCd_InScope(Collection<String> cusCdList) {
        doSetCusCd_InScope(cusCdList);
    }

    protected void doSetCusCd_InScope(Collection<String> cusCdList) {
        regINS(CK_INS, cTL(cusCdList), xgetCValueCusCd(), "cus_cd");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * cus_cd: {UQ+, NotNull, varchar(40)}
     * @param cusCdList The collection of cusCd as notInScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusCd_NotInScope(Collection<String> cusCdList) {
        doSetCusCd_NotInScope(cusCdList);
    }

    protected void doSetCusCd_NotInScope(Collection<String> cusCdList) {
        regINS(CK_NINS, cTL(cusCdList), xgetCValueCusCd(), "cus_cd");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * cus_cd: {UQ+, NotNull, varchar(40)} <br>
     * <pre>e.g. setCusCd_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param cusCd The value of cusCd as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setCusCd_LikeSearch(String cusCd, ConditionOptionCall<LikeSearchOption> opLambda) {
        setCusCd_LikeSearch(cusCd, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * cus_cd: {UQ+, NotNull, varchar(40)} <br>
     * <pre>e.g. setCusCd_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param cusCd The value of cusCd as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setCusCd_LikeSearch(String cusCd, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(cusCd), xgetCValueCusCd(), "cus_cd", likeSearchOption);
    }
     ...
     * cus_cd: {UQ+, NotNull, varchar(40)}
     * @param cusCd The value of cusCd as notLikeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setCusCd_NotLikeSearch(String cusCd, ConditionOptionCall<LikeSearchOption> opLambda) {
        setCusCd_NotLikeSearch(cusCd, xcLSOP(opLambda));
    }
     ...
     */
    protected void setCusCd_NotLikeSearch(String cusCd, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(cusCd), xgetCValueCusCd(), "cus_cd", likeSearchOption);
    }

    protected void regCusCd(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCusCd(), "cus_cd"); }
    protected abstract ConditionValue xgetCValueCusCd();
     ...
     * Equal(=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * addr: {varchar(100)}
     * @param addr The value of addr as equal. (NullAllowed: if null (or empty), no condition)
     */
    public void setAddr_Equal(String addr) {
        doSetAddr_Equal(fRES(addr));
    }

    protected void doSetAddr_Equal(String addr) {
        regAddr(CK_EQ, addr);
    }
     ...
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * addr: {varchar(100)}
     * @param addr The value of addr as notEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setAddr_NotEqual(String addr) {
        doSetAddr_NotEqual(fRES(addr));
    }

    protected void doSetAddr_NotEqual(String addr) {
        regAddr(CK_NES, addr);
    }
     ...
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * addr: {varchar(100)}
     * @param addr The value of addr as greaterThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setAddr_GreaterThan(String addr) {
        regAddr(CK_GT, fRES(addr));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * addr: {varchar(100)}
     * @param addr The value of addr as lessThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setAddr_LessThan(String addr) {
        regAddr(CK_LT, fRES(addr));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * addr: {varchar(100)}
     * @param addr The value of addr as greaterEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setAddr_GreaterEqual(String addr) {
        regAddr(CK_GE, fRES(addr));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * addr: {varchar(100)}
     * @param addr The value of addr as lessEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setAddr_LessEqual(String addr) {
        regAddr(CK_LE, fRES(addr));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * addr: {varchar(100)}
     * @param addrList The collection of addr as inScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setAddr_InScope(Collection<String> addrList) {
        doSetAddr_InScope(addrList);
    }

    protected void doSetAddr_InScope(Collection<String> addrList) {
        regINS(CK_INS, cTL(addrList), xgetCValueAddr(), "addr");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * addr: {varchar(100)}
     * @param addrList The collection of addr as notInScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setAddr_NotInScope(Collection<String> addrList) {
        doSetAddr_NotInScope(addrList);
    }

    protected void doSetAddr_NotInScope(Collection<String> addrList) {
        regINS(CK_NINS, cTL(addrList), xgetCValueAddr(), "addr");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * addr: {varchar(100)} <br>
     * <pre>e.g. setAddr_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param addr The value of addr as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setAddr_LikeSearch(String addr, ConditionOptionCall<LikeSearchOption> opLambda) {
        setAddr_LikeSearch(addr, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * addr: {varchar(100)} <br>
     * <pre>e.g. setAddr_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param addr The value of addr as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setAddr_LikeSearch(String addr, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(addr), xgetCValueAddr(), "addr", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * addr: {varchar(100)}
     * @param addr The value of addr as notLikeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setAddr_NotLikeSearch(String addr, ConditionOptionCall<LikeSearchOption> opLambda) {
        setAddr_NotLikeSearch(addr, xcLSOP(opLambda));
    }
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    protected void setAddr_NotLikeSearch(String addr, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(addr), xgetCValueAddr(), "addr", likeSearchOption);
    }
     ...
     * addr: {varchar(100)}
     */
    public void setAddr_IsNull() { regAddr(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * addr: {varchar(100)}
     */
    public void setAddr_IsNullOrEmpty() { regAddr(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * addr: {varchar(100)}
     */
    public void setAddr_IsNotNull() { regAddr(CK_ISNN, DOBJ); }

    protected void regAddr(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueAddr(), "addr"); }
    protected abstract ConditionValue xgetCValueAddr();

    /**
     * Equal(=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * bldg: {varchar(100)}
     * @param bldg The value of bldg as equal. (NullAllowed: if null (or empty), no condition)
     */
    public void setBldg_Equal(String bldg) {
        doSetBldg_Equal(fRES(bldg));
    }

    protected void doSetBldg_Equal(String bldg) {
        regBldg(CK_EQ, bldg);
    }
     ...
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * bldg: {varchar(100)}
     * @param bldg The value of bldg as notEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setBldg_NotEqual(String bldg) {
        doSetBldg_NotEqual(fRES(bldg));
    }

    protected void doSetBldg_NotEqual(String bldg) {
        regBldg(CK_NES, bldg);
    }
     ...
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * bldg: {varchar(100)}
     * @param bldg The value of bldg as greaterThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setBldg_GreaterThan(String bldg) {
        regBldg(CK_GT, fRES(bldg));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * bldg: {varchar(100)}
     * @param bldg The value of bldg as lessThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setBldg_LessThan(String bldg) {
        regBldg(CK_LT, fRES(bldg));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * bldg: {varchar(100)}
     * @param bldg The value of bldg as greaterEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setBldg_GreaterEqual(String bldg) {
        regBldg(CK_GE, fRES(bldg));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * bldg: {varchar(100)}
     * @param bldg The value of bldg as lessEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setBldg_LessEqual(String bldg) {
        regBldg(CK_LE, fRES(bldg));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * bldg: {varchar(100)}
     * @param bldgList The collection of bldg as inScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setBldg_InScope(Collection<String> bldgList) {
        doSetBldg_InScope(bldgList);
    }

    protected void doSetBldg_InScope(Collection<String> bldgList) {
        regINS(CK_INS, cTL(bldgList), xgetCValueBldg(), "bldg");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * bldg: {varchar(100)}
     * @param bldgList The collection of bldg as notInScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setBldg_NotInScope(Collection<String> bldgList) {
        doSetBldg_NotInScope(bldgList);
    }

    protected void doSetBldg_NotInScope(Collection<String> bldgList) {
        regINS(CK_NINS, cTL(bldgList), xgetCValueBldg(), "bldg");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * bldg: {varchar(100)} <br>
     * <pre>e.g. setBldg_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param bldg The value of bldg as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setBldg_LikeSearch(String bldg, ConditionOptionCall<LikeSearchOption> opLambda) {
        setBldg_LikeSearch(bldg, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * bldg: {varchar(100)} <br>
     * <pre>e.g. setBldg_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param bldg The value of bldg as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setBldg_LikeSearch(String bldg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(bldg), xgetCValueBldg(), "bldg", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * bldg: {varchar(100)}
     * @param bldg The value of bldg as notLikeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setBldg_NotLikeSearch(String bldg, ConditionOptionCall<LikeSearchOption> opLambda) {
        setBldg_NotLikeSearch(bldg, xcLSOP(opLambda));
    }
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    protected void setBldg_NotLikeSearch(String bldg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(bldg), xgetCValueBldg(), "bldg", likeSearchOption);
    }
     ...
     * bldg: {varchar(100)}
     */
    public void setBldg_IsNull() { regBldg(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * bldg: {varchar(100)}
     */
    public void setBldg_IsNullOrEmpty() { regBldg(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * bldg: {varchar(100)}
     */
    public void setBldg_IsNotNull() { regBldg(CK_ISNN, DOBJ); }

    protected void regBldg(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBldg(), "bldg"); }
    protected abstract ConditionValue xgetCValueBldg();

    /**
     * Equal(=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_sec: {varchar(100)}
     * @param cusConSec The value of cusConSec as equal. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConSec_Equal(String cusConSec) {
        doSetCusConSec_Equal(fRES(cusConSec));
    }

    protected void doSetCusConSec_Equal(String cusConSec) {
        regCusConSec(CK_EQ, cusConSec);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_sec: {varchar(100)}
     * @param cusConSec The value of cusConSec as notEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConSec_NotEqual(String cusConSec) {
        doSetCusConSec_NotEqual(fRES(cusConSec));
    }

    protected void doSetCusConSec_NotEqual(String cusConSec) {
        regCusConSec(CK_NES, cusConSec);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_sec: {varchar(100)}
     * @param cusConSec The value of cusConSec as greaterThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConSec_GreaterThan(String cusConSec) {
        regCusConSec(CK_GT, fRES(cusConSec));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_sec: {varchar(100)}
     * @param cusConSec The value of cusConSec as lessThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConSec_LessThan(String cusConSec) {
        regCusConSec(CK_LT, fRES(cusConSec));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_sec: {varchar(100)}
     * @param cusConSec The value of cusConSec as greaterEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConSec_GreaterEqual(String cusConSec) {
        regCusConSec(CK_GE, fRES(cusConSec));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_sec: {varchar(100)}
     * @param cusConSec The value of cusConSec as lessEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConSec_LessEqual(String cusConSec) {
        regCusConSec(CK_LE, fRES(cusConSec));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * cus_con_sec: {varchar(100)}
     * @param cusConSecList The collection of cusConSec as inScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConSec_InScope(Collection<String> cusConSecList) {
        doSetCusConSec_InScope(cusConSecList);
    }

    protected void doSetCusConSec_InScope(Collection<String> cusConSecList) {
        regINS(CK_INS, cTL(cusConSecList), xgetCValueCusConSec(), "cus_con_sec");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * cus_con_sec: {varchar(100)}
     * @param cusConSecList The collection of cusConSec as notInScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConSec_NotInScope(Collection<String> cusConSecList) {
        doSetCusConSec_NotInScope(cusConSecList);
    }

    protected void doSetCusConSec_NotInScope(Collection<String> cusConSecList) {
        regINS(CK_NINS, cTL(cusConSecList), xgetCValueCusConSec(), "cus_con_sec");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * cus_con_sec: {varchar(100)} <br>
     * <pre>e.g. setCusConSec_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param cusConSec The value of cusConSec as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setCusConSec_LikeSearch(String cusConSec, ConditionOptionCall<LikeSearchOption> opLambda) {
        setCusConSec_LikeSearch(cusConSec, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * cus_con_sec: {varchar(100)} <br>
     * <pre>e.g. setCusConSec_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param cusConSec The value of cusConSec as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setCusConSec_LikeSearch(String cusConSec, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(cusConSec), xgetCValueCusConSec(), "cus_con_sec", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * cus_con_sec: {varchar(100)}
     * @param cusConSec The value of cusConSec as notLikeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setCusConSec_NotLikeSearch(String cusConSec, ConditionOptionCall<LikeSearchOption> opLambda) {
        setCusConSec_NotLikeSearch(cusConSec, xcLSOP(opLambda));
    }
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    protected void setCusConSec_NotLikeSearch(String cusConSec, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(cusConSec), xgetCValueCusConSec(), "cus_con_sec", likeSearchOption);
    }
     ...
     * cus_con_sec: {varchar(100)}
     */
    public void setCusConSec_IsNull() { regCusConSec(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * cus_con_sec: {varchar(100)}
     */
    public void setCusConSec_IsNullOrEmpty() { regCusConSec(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * cus_con_sec: {varchar(100)}
     */
    public void setCusConSec_IsNotNull() { regCusConSec(CK_ISNN, DOBJ); }

    protected void regCusConSec(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCusConSec(), "cus_con_sec"); }
    protected abstract ConditionValue xgetCValueCusConSec();

    /**
     * Equal(=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_name: {varchar(100)}
     * @param cusConName The value of cusConName as equal. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConName_Equal(String cusConName) {
        doSetCusConName_Equal(fRES(cusConName));
    }

    protected void doSetCusConName_Equal(String cusConName) {
        regCusConName(CK_EQ, cusConName);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_name: {varchar(100)}
     * @param cusConName The value of cusConName as notEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConName_NotEqual(String cusConName) {
        doSetCusConName_NotEqual(fRES(cusConName));
    }

    protected void doSetCusConName_NotEqual(String cusConName) {
        regCusConName(CK_NES, cusConName);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_name: {varchar(100)}
     * @param cusConName The value of cusConName as greaterThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConName_GreaterThan(String cusConName) {
        regCusConName(CK_GT, fRES(cusConName));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_name: {varchar(100)}
     * @param cusConName The value of cusConName as lessThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConName_LessThan(String cusConName) {
        regCusConName(CK_LT, fRES(cusConName));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_name: {varchar(100)}
     * @param cusConName The value of cusConName as greaterEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConName_GreaterEqual(String cusConName) {
        regCusConName(CK_GE, fRES(cusConName));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * cus_con_name: {varchar(100)}
     * @param cusConName The value of cusConName as lessEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConName_LessEqual(String cusConName) {
        regCusConName(CK_LE, fRES(cusConName));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * cus_con_name: {varchar(100)}
     * @param cusConNameList The collection of cusConName as inScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConName_InScope(Collection<String> cusConNameList) {
        doSetCusConName_InScope(cusConNameList);
    }

    protected void doSetCusConName_InScope(Collection<String> cusConNameList) {
        regINS(CK_INS, cTL(cusConNameList), xgetCValueCusConName(), "cus_con_name");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * cus_con_name: {varchar(100)}
     * @param cusConNameList The collection of cusConName as notInScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setCusConName_NotInScope(Collection<String> cusConNameList) {
        doSetCusConName_NotInScope(cusConNameList);
    }

    protected void doSetCusConName_NotInScope(Collection<String> cusConNameList) {
        regINS(CK_NINS, cTL(cusConNameList), xgetCValueCusConName(), "cus_con_name");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * cus_con_name: {varchar(100)} <br>
     * <pre>e.g. setCusConName_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param cusConName The value of cusConName as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setCusConName_LikeSearch(String cusConName, ConditionOptionCall<LikeSearchOption> opLambda) {
        setCusConName_LikeSearch(cusConName, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * cus_con_name: {varchar(100)} <br>
     * <pre>e.g. setCusConName_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param cusConName The value of cusConName as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setCusConName_LikeSearch(String cusConName, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(cusConName), xgetCValueCusConName(), "cus_con_name", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * cus_con_name: {varchar(100)}
     * @param cusConName The value of cusConName as notLikeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setCusConName_NotLikeSearch(String cusConName, ConditionOptionCall<LikeSearchOption> opLambda) {
        setCusConName_NotLikeSearch(cusConName, xcLSOP(opLambda));
    }
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    protected void setCusConName_NotLikeSearch(String cusConName, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(cusConName), xgetCValueCusConName(), "cus_con_name", likeSearchOption);
    }
     ...
     * cus_con_name: {varchar(100)}
     */
    public void setCusConName_IsNull() { regCusConName(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * cus_con_name: {varchar(100)}
     */
    public void setCusConName_IsNullOrEmpty() { regCusConName(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * cus_con_name: {varchar(100)}
     */
    public void setCusConName_IsNotNull() { regCusConName(CK_ISNN, DOBJ); }

    protected void regCusConName(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCusConName(), "cus_con_name"); }
    protected abstract ConditionValue xgetCValueCusConName();

    /**
     * Equal(=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * tel: {varchar(100)}
     * @param tel The value of tel as equal. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * tel: {varchar(100)}
     * @param tel The value of tel as notEqual. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * tel: {varchar(100)}
     * @param tel The value of tel as greaterThan. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * tel: {varchar(100)}
     * @param tel The value of tel as lessThan. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * tel: {varchar(100)}
     * @param tel The value of tel as greaterEqual. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * tel: {varchar(100)}
     * @param tel The value of tel as lessEqual. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * tel: {varchar(100)}
     * @param telList The collection of tel as inScope. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * tel: {varchar(100)}
     * @param telList The collection of tel as notInScope. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * @param tel The value of tel as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * tel: {varchar(100)}
     * @param tel The value of tel as notLikeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
     ...
     * tel: {varchar(100)}
     */
    public void setTel_IsNullOrEmpty() { regTel(CK_ISNOE, DOBJ); }
     ...
     * sales_amount: {int8(19)}
     */
    public void setSalesAmount_IsNull() { regSalesAmount(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * sales_amount: {int8(19)}
     */
    public void setSalesAmount_IsNotNull() { regSalesAmount(CK_ISNN, DOBJ); }
