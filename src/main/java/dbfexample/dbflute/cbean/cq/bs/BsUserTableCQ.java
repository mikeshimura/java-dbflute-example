...
public class BsUserTableCQ extends AbstractBsUserTableCQ {
    ...
    public Map<String, EmployeeCQ> xdfgetId_ExistsReferrer_EmployeeList() { return xgetSQueMap("id_ExistsReferrer_EmployeeList"); }
    public String keepId_ExistsReferrer_EmployeeList(EmployeeCQ sq) { return xkeepSQue("id_ExistsReferrer_EmployeeList", sq); }

    public Map<String, EmployeeCQ> xdfgetId_NotExistsReferrer_EmployeeList() { return xgetSQueMap("id_NotExistsReferrer_EmployeeList"); }
    public String keepId_NotExistsReferrer_EmployeeList(EmployeeCQ sq) { return xkeepSQue("id_NotExistsReferrer_EmployeeList", sq); }

    public Map<String, EmployeeCQ> xdfgetId_SpecifyDerivedReferrer_EmployeeList() { return xgetSQueMap("id_SpecifyDerivedReferrer_EmployeeList"); }
    public String keepId_SpecifyDerivedReferrer_EmployeeList(EmployeeCQ sq) { return xkeepSQue("id_SpecifyDerivedReferrer_EmployeeList", sq); }

    public Map<String, EmployeeCQ> xdfgetId_QueryDerivedReferrer_EmployeeList() { return xgetSQueMap("id_QueryDerivedReferrer_EmployeeList"); }
    public String keepId_QueryDerivedReferrer_EmployeeList(EmployeeCQ sq) { return xkeepSQue("id_QueryDerivedReferrer_EmployeeList", sq); }
    public Map<String, Object> xdfgetId_QueryDerivedReferrer_EmployeeListParameter() { return xgetSQuePmMap("id_QueryDerivedReferrer_EmployeeList"); }
    public String keepId_QueryDerivedReferrer_EmployeeListParameter(Object pm) { return xkeepSQuePm("id_QueryDerivedReferrer_EmployeeList", pm); }
