...
public abstract class AbstractBsUserTableCQ extends AbstractConditionQuery {
     ...
     * {exists (select sec_id from employee where ...)} <br>
     * employee by sec_id, named 'employeeAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">existsEmployee</span>(employeeCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     employeeCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of EmployeeList for 'exists'. (NotNull)
     */
    public void existsEmployee(SubQuery<EmployeeCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EmployeeCB cb = new EmployeeCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepId_ExistsReferrer_EmployeeList(cb.query());
        registerExistsReferrer(cb.query(), "id", "sec_id", pp, "employeeList");
    }
    public abstract String keepId_ExistsReferrer_EmployeeList(EmployeeCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select sec_id from employee where ...)} <br>
     * employee by sec_id, named 'employeeAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsEmployee</span>(employeeCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     employeeCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of Id_NotExistsReferrer_EmployeeList for 'not exists'. (NotNull)
     */
    public void notExistsEmployee(SubQuery<EmployeeCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EmployeeCB cb = new EmployeeCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepId_NotExistsReferrer_EmployeeList(cb.query());
        registerNotExistsReferrer(cb.query(), "id", "sec_id", pp, "employeeList");
    }
    public abstract String keepId_NotExistsReferrer_EmployeeList(EmployeeCQ sq);

    public void xsderiveEmployeeList(String fn, SubQuery<EmployeeCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EmployeeCB cb = new EmployeeCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepId_SpecifyDerivedReferrer_EmployeeList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "id", "sec_id", pp, "employeeList", al, op);
    }
    public abstract String keepId_SpecifyDerivedReferrer_EmployeeList(EmployeeCQ sq);

    /**
     * Prepare for (Query)DerivedReferrer (correlated sub-query). <br>
     * {FOO &lt;= (select max(BAR) from employee where ...)} <br>
     * employee by sec_id, named 'employeeAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedEmployee()</span>.<span style="color: #CC4747">max</span>(employeeCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     employeeCB.specify().<span style="color: #CC4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *     employeeCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     * }).<span style="color: #CC4747">greaterEqual</span>(123); <span style="color: #3F7E5E">// condition to derived column</span>
     * </pre>
     * @return The object to set up a function for referrer table. (NotNull)
     */
    public HpQDRFunction<EmployeeCB> derivedEmployee() {
        return xcreateQDRFunctionEmployeeList();
    }
    protected HpQDRFunction<EmployeeCB> xcreateQDRFunctionEmployeeList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveEmployeeList(fn, sq, rd, vl, op));
    }
    public void xqderiveEmployeeList(String fn, SubQuery<EmployeeCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EmployeeCB cb = new EmployeeCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepId_QueryDerivedReferrer_EmployeeList(cb.query()); String prpp = keepId_QueryDerivedReferrer_EmployeeListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "id", "sec_id", sqpp, "employeeList", rd, vl, prpp, op);
    }
    public abstract String keepId_QueryDerivedReferrer_EmployeeList(EmployeeCQ sq);
    public abstract String keepId_QueryDerivedReferrer_EmployeeListParameter(Object vl);
     ...
     */
    public HpSLCFunction<UserTableCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, UserTableCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<UserTableCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, UserTableCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<UserTableCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, UserTableCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<UserTableCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, UserTableCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<UserTableCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, UserTableCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<UserTableCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, UserTableCB.class);
    }
