...
public abstract class BsProductBhv extends AbstractBehaviorWritable<Product, ProductCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<Product> selectByUniqueOf(String prdCd, Integer delFlag) {
        return facadeSelectByUniqueOf(prdCd, delFlag);
    }

    protected OptionalEntity<Product> facadeSelectByUniqueOf(String prdCd, Integer delFlag) {
        return doSelectByUniqueOf(prdCd, delFlag, typeOfSelectedEntity());
    }

    protected <ENTITY extends Product> OptionalEntity<ENTITY> doSelectByUniqueOf(String prdCd, Integer delFlag, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(prdCd, delFlag), tp), prdCd, delFlag);
    }

    protected ProductCB xprepareCBAsUniqueOf(String prdCd, Integer delFlag) {
        assertObjectNotNull("prdCd", prdCd);assertObjectNotNull("delFlag", delFlag);
        return newConditionBean().acceptUniqueOf(prdCd, delFlag);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadSalesSlip</span>(<span style="color: #553000">productList</span>, <span style="color: #553000">slipCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<SalesSlip> loadSalesSlip(List<Product> productList, ReferrerConditionSetupper<SalesSlipCB> refCBLambda) {
        xassLRArg(productList, refCBLambda);
        return doLoadSalesSlip(productList, new LoadReferrerOption<SalesSlipCB, SalesSlip>().xinit(refCBLambda));
    }
     ...
     * sales_slip by prd_id, named 'salesSlipList'.
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadSalesSlip</span>(<span style="color: #553000">product</span>, <span style="color: #553000">slipCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">slipCB</span>.setupSelect...
     *     <span style="color: #553000">slipCB</span>.query().set...
     *     <span style="color: #553000">slipCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">product</span>.<span style="color: #CC4747">getSalesSlipList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<SalesSlip> loadSalesSlip(Product product, ReferrerConditionSetupper<SalesSlipCB> refCBLambda) {
        xassLRArg(product, refCBLambda);
        return doLoadSalesSlip(xnewLRLs(product), new LoadReferrerOption<SalesSlipCB, SalesSlip>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<SalesSlip> doLoadSalesSlip(List<Product> productList, LoadReferrerOption<SalesSlipCB, SalesSlip> option) {
        return helpLoadReferrerInternally(productList, option, "salesSlipList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadStock</span>(<span style="color: #553000">productList</span>, <span style="color: #553000">stockCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Stock> loadStock(List<Product> productList, ReferrerConditionSetupper<StockCB> refCBLambda) {
        xassLRArg(productList, refCBLambda);
        return doLoadStock(productList, new LoadReferrerOption<StockCB, Stock>().xinit(refCBLambda));
    }
     ...
     * stock by prd_id, named 'stockList'.
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadStock</span>(<span style="color: #553000">product</span>, <span style="color: #553000">stockCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">stockCB</span>.setupSelect...
     *     <span style="color: #553000">stockCB</span>.query().set...
     *     <span style="color: #553000">stockCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">product</span>.<span style="color: #CC4747">getStockList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Stock> loadStock(Product product, ReferrerConditionSetupper<StockCB> refCBLambda) {
        xassLRArg(product, refCBLambda);
        return doLoadStock(xnewLRLs(product), new LoadReferrerOption<StockCB, Stock>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Stock> doLoadStock(List<Product> productList, LoadReferrerOption<StockCB, Stock> option) {
        return helpLoadReferrerInternally(productList, option, "stockList");
    }
